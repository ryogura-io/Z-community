            ...
            try {
                ...
                if (!activeSpawn) {
                    return bot.sendMessage(
                        chatId,
                        "❌ No active card spawn in this group!",
                    );
                }
                ...
                if (!player) {
                    return bot.sendMessage(
                        chatId,
                        "❌ Please register first using !register <name>",
                    );
                }
                ...
                if (player.shards < cardPrice) {
                    return bot.sendMessage(
                        chatId,
                        `❌ You need *${cardPrice} shards* to claim this card!\n💰 Your shards: ${player.shards}`,
                    );
                }
                ...
                if (args[0] && !isNaN(args[0])) {
                    ...
                    if (
                        ...
                        try {
                            ...
                            await bot.sendVideo(chatId, videoBuffer, cardMsg, {
                                gif: true,
                            });
        ...
        execute: async ({ sender, chatId, args, bot }) => {
            try {
                ...
                if (args[0] && !isNaN(args[0])) {
                    ...
                    if (
                        ...
                        try {
                            ...
                            return bot.sendVideo(chatId, videoBuffer, cardMsg, {
                                gif: true,
                            });
                        } catch (conversionError) {
                            console.error(
                ...
                const filledSlots = player.deck
                    ...
                    .filter(
                        (entry) =>
                            entry.card !== null && entry.card !== undefined,
                    );
    ...
    mtd: {
        ...
        execute: async ({ sender, chatId, args, bot }) => {
            if (!args[0]) {
                return bot.sendMessage(
                    chatId,
                    "❌ Usage: !mtd <collection_numbers> (e.g., !mtd 1 5 12)",
                );
            }
                ...
                for (const cardIndex of cardNumbers) {
                    ...
                    if (emptySlot === -1) {
                        await bot.sendMessage(
                            chatId,
                            "⚠️ Deck is full! Some cards couldn't be moved.",
                        );
                        break;
                    }
    ...
    mtc: {
        ...
        execute: async ({ sender, chatId, args, bot }) => {
            ...
            try {
                ...
                await bot.sendMessage(
                    chatId,
                    `✅ Moved ${moved} card(s) to collection!`,
                );
            } catch (error) {
        ...
        execute: async ({ chatId, args, bot }) => {
            ...
            try {
                ...
                if (collectors.length === 0) {
                    return bot.sendMessage(
                        chatId,
                        `📦 No collectors found for series: ${seriesName}`,
                    );
                }
        ...
        execute: async ({ sender, chatId, args, bot }) => {
            ...
            try {
                ...
                if (seriesCards.length === 0) {
                    return bot.sendMessage(
                        chatId,
                        `📦 No cards found for series: ${seriesName}`,
                    );
                }
    ...
    givecard: {
        ...
        execute: async ({ sender, chatId, message, args, bot }) => {
            ...
            if (
                ...
                return bot.sendMessage(
                    chatId,
                    "❌ Reply to a user to send them Card!",
                );
            }
            ...
            try {
                ...
                if (transferred.length === 0) {
                    return bot.sendMessage(
                        chatId,
                        "❌ No valid cards selected for transfer!",
                    );
                }
